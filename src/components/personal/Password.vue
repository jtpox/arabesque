                    ...
                    <div class="col-md-8 offset-md-2">
                        ...
                        <form v-on:submit.prevent="update()">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" v-model="old_password" id="old_password" />
                            </div>
...
export default {
  ...
  methods: {
    update() {
      ...
      this.axios.post(this.api + "/auth/update/password", { old: this.old_password, new: this.new_password }).then(res => {
          if(res.data.error == 0) {
